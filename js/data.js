...
const GameData = (() => {
  ...
  /* ---------- ふたりせんよう ミニゲーム ---------- */
  const SPECIALS = {
    solo: ['block', 'boxing', 'dance4', 'shoot4', 'cmdmarch', 'surf', 'fruit4', 'mirror', 'hold4', 'reverse', 'soccer', 'crane', 'tennis4', 'animals', 'pinwheel', 'word', 'shuriken', 'sugoroku', 'mole4', 'piano', ...Patterns.ARROW_GAMES2],   // アローせんよう(↑↓←→ が べつのアクション) 40本
